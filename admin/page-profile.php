        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="chef-thumb">
              <img src="<?php if($user->user_foto == '') echo '../assets/images/no-pic.png'; echo $user->user_foto;?>" class="img-responsive">
            </div>
            <div class="form-group">
              <h3 align="center"> <?php echo $user->user_nama;?></h3>
      ...
      <div id="form-edit" class="col-md-8 col-sm-8 col-xs-12" >
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="form-edit-user" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <input id="userID" type="hidden" name="userID" value="<?=$userID?>">
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="username" name="username" required="required" value="<?=$user->user_nama;?>" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="email" name="email" required="required" value="<?=$user->user_email;?>" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="status" form="form-edit-user" class="form-control" title="-Choose option-">
