...
?>
                        ...
                        <div class=" portfolio-actbutton" style="bottom:-15px;">
                          <center>
                            <span >
                                ...
                                <button type="button" class="btn btn-danger btn-icon btn-circle" data-target="#delete-dialog-operator" data-nm="<?=$data->user_nama; ?>" data-hapus="<?=$data->user_id; ?>"  title="Delete user" data-toggle="modal"><i class="fa fa-times"></i></button>
                                <?php } ?>
                            </span>
                          </center>
                        </div> 
  ...
  <div class="modal animated rotateInUpLeft" id="delete-dialog-operator">
...
$(document).ready(function() {
  $('#delete-dialog-operator').on('show.bs.modal', function(e) {
